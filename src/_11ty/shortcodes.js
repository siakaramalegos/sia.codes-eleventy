...
const SHARE_FILE = "share_tmpl.jpg"
...
function socialImageUrl(title, description) {
  ...
  return `${BASE_URL}${imageConfig}/${titleConfig}/${taglineConfig}/${FOLDER}${SHARE_FILE}`
}
